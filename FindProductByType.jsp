...
<%--<%@ page import="com.mycompany.iotbay1.models.Product" %>&lt;%&ndash;--%>
...
<%--<div class="De">--%>
<%--<%--%>
<%--    List<Product> productList = (List<Product>) session.getAttribute("productByType");--%>
