...
<div class="De">
        <%
         List<Order> orderList = (List<Order>) session.getAttribute("orderByid");
//    Order order = (Order) session.getAttribute("orderByUserId");
if(orderList.isEmpty()){
        String errorMessage = "No such order,please enter again";
